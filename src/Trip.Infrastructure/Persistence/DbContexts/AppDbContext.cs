...
namespace Trip.Infrastructure.Persistence.DbContexts;
...
public class AppDbContext : IdentityDbContext<AppUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var routesFromJson = File.ReadAllText(Path.Combine(AppContext.BaseDirectory, "Assets", "tourist-routes.json"));
        ...
        var routePicturesFromJson =
            File.ReadAllText(Path.Combine(AppContext.BaseDirectory, "Assets", "tourist-route-pictures.json"));
